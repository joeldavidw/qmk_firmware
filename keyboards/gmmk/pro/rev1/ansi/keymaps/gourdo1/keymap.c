...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN1] = LAYOUT(
        EE_CLR,  _______, _______, _______, _______, KC_MPRV, KC_MNXT, KC_MPLY, KC_MSTP, KC_VOLD, KC_VOLU, KC_PSCR, KC_SLCK, KC_PAUS,           KC_SLEP,
        PRNCONF, TG_CAPS, TG_PAD,  TG_ESC,  TG_DEL,  TG_TDCAP,TG_ENC,  TG_INS,TG_SPCMOD,TG_AUTOCR, _______, RGB_TOD, RGB_TOI, _______,           RGB_TOG,
        _______, RGB_SAD, RGB_VAI, RGB_SAI, NK_TOGG, _______, _______,   _______, _______, _______, _______, _______,  _______,  QK_BOOT,           KC_MPLY,
        KC_CAPS, RGB_HUD, RGB_VAD, RGB_HUI, _______, _______,   _______, _______, _______, _______,  _______, _______,          _______,           KC_MNXT,
        _______,          RGB_NITE,_______, _______, _______, QK_BOOT, KC_NLCK, _______, _______, _______,  _______,           _______, RGB_MOD,  _______,
